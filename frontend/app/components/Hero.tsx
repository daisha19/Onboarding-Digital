  ...
  return (
    <section className="w-full max-w-5xl mx-auto px-8 py-16">
      <div className="flex flex-col items-center text-center gap-6">
        <span className="inline-block bg-blue-50 text-blue-700 rounded-full px-4 py-2 text-sm">Plataforma segura e confiavel</span>
        <h1 className="text-5xl font-extrabold leading-tight text-zinc-900">
          Simplifique o processo de <span className="text-blue-600">admissao</span>
        </h1>
        ...
        <div className="flex items-center gap-4 mt-6">
          <Link className="bg-blue-600 text-white px-6 py-3 rounded-md shadow" href="/cadastro">Comecar Agora</Link>
          <Link className="border border-zinc-200 px-5 py-3 rounded-md" href="/tela-de-login">Ja tenho conta</Link>
        </div>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="p-6 bg-white rounded-lg shadow-sm border border-zinc-100">
          ...
          <p className="text-sm text-zinc-500 mt-2">Envie seus documentos de forma rapida e segura. Interface intuitiva e facil de usar.</p>
        </div>
        ...
        <div className="p-6 bg-white rounded-lg shadow-sm border border-zinc-100">
          ...
          <p className="text-sm text-zinc-500 mt-2">Monitore o status dos seus documentos e receba notificacoes sobre aprovacoes.</p>
        </div>
        ...
        <div className="p-6 bg-white rounded-lg shadow-sm border border-zinc-100">
          ...
          <h4 className="font-semibold">Seguranca Garantida</h4>
